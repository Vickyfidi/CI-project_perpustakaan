        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                table = $('#table').DataTable({
                    ...
                    "order": [],
                    "ajax": {
                        "url": "<?php echo site_url('petugas/buku/ajax_list') ?>",
                        "type": "POST",
                        "data": function(data) {
            ...
            function edit_buku(id) {
                ...
                $.ajax({
                    url: "<?php echo site_url('petugas/buku/ajax_edit') ?>/" + id,
                    type: "GET",
                    dataType: "JSON",
            ...
            function save() {
                ...
                var url;
                if (save_method == 'add') {
                    url = "<?php echo site_url('petugas/buku/ajax_add') ?>";
                } else {
                    url = "<?php echo site_url('petugas/buku/ajax_update') ?>";
                }
            ...
            function delete_buku(id) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "<?= site_url('petugas/buku/ajax_delete') ?>/" + id,
                            dataType: "JSON",
                            success: function(data) {
                                $('#modal_form').modal('hide');
                                reload_table();
