    ...
    .swal2-popup {
        ...
        <script type="text/javascript">
            ...
            function edit_siswa(id) {
                ...
                $.ajax({
                    url: "<?php echo site_url('admin/siswa/ajax_edit') ?>/" + id,
                    type: "GET",
                    dataType: "JSON",
            ...
            function save() {
                ...
                var url;
                if (save_method == 'add') {
                    url = "<?php echo site_url('admin/siswa/ajax_add') ?>";
                } else {
                    url = "<?php echo site_url('admin/siswa/ajax_update') ?>";
                }
            ...
            function delete_siswa(id) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "<?= site_url('admin/siswa/ajax_delete') ?>/" + id,
                            dataType: "JSON",
                            success: function(data) {
                                $('#modal_form').modal('hide');
                                reload_table();
