...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#table').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?php echo site_url('admin/kategori_buku/ajax_list') ?>",
                "type": "POST"
            },
            "columnDefs": [{
                "targets": [-1],
    ...
    function edit_kategori(id_kategori) {
        ...
        $.ajax({
            url: "<?php echo site_url('admin/kategori_buku/ajax_edit/') ?>/" + id_kategori,
            type: "GET",
            dataType: "JSON",
    ...
    function delete_kategori(id_kategori) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "<?= site_url('admin/kategori_buku/ajax_delete') ?>/" + id_kategori,
                    dataType: "JSON",
                    success: function(data) {
    ...
    function save() {
        ...
        var url;
        if (save_method == 'add') {
            url = "<?php echo site_url('admin/kategori_buku/ajax_add') ?>";
        } else {
            url = "<?php echo site_url('admin/kategori_buku/ajax_update') ?>";
        }
        $.ajax({
            url: url,
            type: "POST",
